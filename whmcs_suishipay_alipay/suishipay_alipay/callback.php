...
$gatewaymodule = "suishipay_alipay";
...
$Sign = suishipay_alipay_sign_get(array("transSeqId"=>trim($ReqData['transSeqId']),"orderId"=>trim($ReqData['orderId']),"transAmount"=>trim($ReqData['transAmount']),"payTime"=>trim($ReqData['payTime'])),trim($GATEWAY['merchantSk']));
//额外手续费
$fee = 0;
